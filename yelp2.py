...
posreviews = []
negreviews = []
# all positive reviews for all businesses in one array
for business in fourplus:
    posreviews += fourplus[business]
# all negative reviews
for business in fourminus:
    negreviews += fourminus[business]
